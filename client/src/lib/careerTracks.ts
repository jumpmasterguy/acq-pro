...
export const CAREER_TRACK_DATA: CareerTrackData[] = [
  {
    ...
    bonusLessons: [
      'finance-6', 'finance-8', 'finance-9', 'finance-10', 'business-1', 'business-2', 'business-3',
  ...
  },
  {
    ...
    primaryLessons: [
      ...
      'finance-2', 'finance-5', 'finance-6', 'finance-7', 'finance-8', 'finance-9', 'finance-10', 'business-1', 'business-2', 'business-3',
  ...
  },
  {
    ...
    bonusLessons: [
      'finance-1', 'finance-2', 'finance-5', 'finance-6', 'finance-7', 'finance-8', 'finance-9', 'finance-10', 'business-1', 'business-2', 'business-3',
      'data-1', 'data-2', 'data-3', 'data-4',
