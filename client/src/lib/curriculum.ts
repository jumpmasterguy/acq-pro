    ...
    lessons: [
      {
        ...
        content: [
          ...
          },
          {
            ...
            items: [
              'Competition — the government must generally compete its requirements so multiple companies can bid. This keeps prices fair and ensures the government gets the best value, not just the most connected vendor.|||FAR Part 6 governs competition requirements. Full and open competition is the default — exceptions (sole source, urgency, follow-on) must be documented in a Justification & Approval (J&A) and are scrutinized by oversight bodies. Reducing competition requires CO and often higher-level approval.',
              'Transparency — the rules, evaluation criteria, and award decisions must be documented and defensible. A losing contractor can protest an award if they believe the process was unfair.|||Protests can be filed at the GAO (within 10 days of debriefing), the Court of Federal Claims, or the agency level. The GAO resolves protests within 100 days and has a ~40% sustain rate — meaning roughly 4 in 10 protests result in corrective action. Transparent documentation is the CO\'s best defense.',
              'Accountability — taxpayers, Congress, and oversight agencies (like the GAO and DoD IG) monitor how money is spent. Program managers and contracting officers are personally accountable for following the rules.|||The Anti-Deficiency Act (ADA) makes improper spending a personal liability — not just an organizational one. Violations must be reported to Congress and OMB. The DoD IG and GAO conduct audits that become public record. Acquisition professionals who cut corners face administrative action and potential criminal referral.',
            ],
          },
          {
            type: 'text',
          ...
          },
          {
            ...
            items: [
              'Products (Systems & Equipment) — physical items: aircraft, vehicles, ships, weapons, satellites, radios, body armor. These often involve years of development before they can be produced and fielded. The most complex category.|||Major defense systems (ACAT I programs) can take 15–25 years from concept to full fielding and cost $1B–$100B+. The F-35 program, for example, has a total lifecycle cost estimated above $1.7 trillion. The complexity of systems acquisition is why the DoD 5000 series of instructions exists specifically for it.',
              'Services — people doing work for the government: program management support, IT services, base operations, maintenance, security, training. This is the largest category by contract volume and where most contractors spend their time.|||Services represent over 50% of DoD contract spending by volume. They are governed by FAR Part 37 and the Services Acquisition pathway (DoDI 5000.74) for requirements above $250M. Most services are competed through IDIQ vehicles like OASIS+ rather than standalone contracts.',
              'Research & Development (R&D) — funding for science, technology, experimentation, and innovation. Not buying a finished product, but funding the work to create new capabilities that may eventually become programs.|||R&D is funded through RDT&E appropriations (2-year availability). DoD spends ~$100B/year on R&D across six budget activities: Basic Research (6.1), Applied Research (6.2), Advanced Technology Development (6.3), Advanced Component Development (6.4), System Development (6.5), and Management Support (6.6). The "6.X" number you\'ll see in budget exhibits refers to these categories.',
            ],
          },
          {
            type: 'text',
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            items: [
              'Funds expire — every appropriation has a period of availability. O&M funds must be obligated within one year. After expiration, they can no longer be obligated for new work. After the expenditure period, they close entirely.|||The lifecycle of an appropriation: (1) Available period — can be obligated for new contracts; (2) Expired period (5 years after availability ends) — can only pay existing obligations, no new work; (3) Closed — all balances cancelled, no further payments. O&M: 1-year available + 5-year expired. Procurement: 3-year + 5-year. If a contractor submits an invoice after funds have closed, the government cannot pay it from those funds — it must use current-year money, which requires reprogramming.',
              'You cannot exceed what Congress gave you — a program cannot spend more than its appropriated amount. If a program runs over budget, it must either get more money from Congress (reprogramming) or descope the work.|||Reprogramming moves money between budget lines. Below-threshold reprogramming (under $10M–$20M depending on the service) can be done administratively. Above-threshold reprogramming requires Congressional notification and a waiting period (usually 15–30 days). Emergency reprogramming requests during execution are common on programs with unexpected technical problems and typically involve difficult negotiations with both the service and Congressional committees.',
              'Money must be used for its intended purpose — using RDT&E money to buy production equipment is illegal. Using O&M to build a permanent facility is illegal. These rules are enforced, and violations are serious.|||Bona Fide Need Rule: funds may only be used to meet a genuine, authorized need that arose during the period of availability. Using FY25 O&M to pre-buy FY26 supplies is an ADA violation even if the funds haven\'t expired. The "purpose statute" (31 U.S.C. § 1301) requires that appropriations be used only for the specific purposes for which they were appropriated.',
              'Fiscal year end is a real deadline — the end of the government fiscal year (September 30) is a hard deadline for obligating O&M funds. Programs scramble to obligate expiring funds responsibly — but "use it or lose it" thinking can lead to wasteful spending.|||September is the busiest month in government contracting by volume. Contract modifications, new awards, and delivery orders spike dramatically. "End of year money" is real — programs that have unobligated O&M approaching September 30 are under pressure to obligate it or lose it. This creates procurement pressure that can lead to poorly scoped requirements and rushed awards. GAO has repeatedly flagged end-of-year spending as a waste risk.',
              'Reprogramming requires approval — if a program needs to move money between budget lines or fiscal years, it typically requires Congressional notification or approval depending on the amount.|||There are four types of reprogramming: (1) Above-threshold (Congressional notification required, 15–30 day waiting period); (2) Below-threshold (internal service approval); (3) Transfers (moving between appropriations — very restricted, requires specific statutory authority); (4) Supplemental appropriations (requires a new act of Congress). PMs who anticipate reprogramming needs should work with their financial manager 6–12 months in advance.',
            ],
          },
          {
            type: 'tip',
    ...
    lessons: [
      ...
      quiz: [
          ...
          },
          {
            ...
            correct: 1,
            explanation: "The 1102 occupational series (Contract Specialist) covers acquisition contracting professionals, including those who become warranted Contracting Officers. Series 0340 is the general Program Management series; the Air Force uses Series 1101 for Program Managers specifically. Series 0501 is Financial Administration, and 0801 is General Engineering."
          },
          {
            id: 'q4',
      ...
      },
        {
          ...
          content: {
            novice: {
              ...
              body: 'CMMI stands for Capability Maturity Model Integration. It measures how mature and disciplined a company\'s processes are — does the organization have repeatable, predictable methods, or is every project starting from scratch? DoD cares because when spending hundreds of millions on a system, you need a contractor who can consistently deliver quality work. CMMI rates organizations on a 1–5 scale. Level 1 is chaotic and unpredictable. Level 5 is data-driven continuous improvement. CMMI Level 3 is the common DoD expectation — processes are defined, documented, and followed consistently across the organization. A contractor at Level 1 or 2 is a program risk you must actively manage.',
              keyTerms: [
                { term: 'CMMI', definition: 'Capability Maturity Model Integration — a framework for assessing and improving organizational process maturity. Developed by Carnegie Mellon\'s Software Engineering Institute (SEI), now maintained by the CMMI Institute (ISACA).' },
                { term: 'Maturity Level (ML)', definition: 'A 1–5 rating indicating how well-defined and disciplined an organization\'s processes are. ML3 is the standard DoD expectation for major contractors.' },
                { term: 'Appraisal', definition: 'A formal assessment of an organization\'s processes by a certified CMMI Lead Appraiser resulting in an official Maturity Level rating. Valid for 3 years.' },
                { term: 'PAL', definition: 'Published Appraisal Results — the CMMI Institute\'s public database of all current official CMMI appraisals. Always use this to verify contractor claims.' },
                { term: 'SCAMPI', definition: 'Standard CMMI Appraisal Method for Process Improvement — the formal appraisal method. Only SCAMPI Class A produces an official ML rating.' },
              ],
              keyPoints: [
                'CMMI rates process maturity on a 1–5 scale|||ML1 (Initial): Chaotic and reactive — success depends on individual heroics. ML2 (Managed): Projects are planned and tracked, but practices vary by project. ML3 (Defined): Standard processes documented and followed organization-wide. ML4 (Quantitatively Managed): Statistical process control applied — defect rates and productivity measured quantitatively. ML5 (Optimizing): Continuous improvement institutionalized — the organization systematically learns and innovates from data.',
                'CMMI Level 3 is the standard DoD threshold for major contractors|||ML3 means the contractor has documented, standardized processes used consistently across all projects — not just on their best team. This is the minimum bar for most large DoD software development and systems engineering contracts. Below ML3 means performance is team-dependent and therefore unpredictable program-to-program.',
                'A CMMI appraisal is NOT a certification — it is a time-limited rating|||Unlike ISO certifications, a CMMI appraisal is valid for only 3 years. After that, the organization must re-appraise to maintain their rating. The correct term is "appraised at ML3," not "certified." In source selections, always verify the appraisal date on the PAL database.',
                'CMMI-DEV vs CMMI-SVC — both are relevant to defense|||CMMI-DEV (Development) applies to any development work — hardware, systems engineering, and software. CMMI-SVC (Services) applies to service delivery organizations such as IT support, program management support, and logistics. Both are used in defense contracting. Know which model your contract requires.',
                'Verify contractor CMMI claims on the PAL database|||Every official SCAMPI A appraisal is published in the CMMI Institute\'s PAL at cmmiinstitute.com/pars. Check three things: (1) Is the appraisal current — within 3 years? (2) Does the appraised organizational unit match the unit that will perform your contract? (3) Is the model type correct (DEV vs. SVC)?',
              ],
            },
            intermediate: {
              title: 'CMMI in DoD Source Selections and Contract Management',
              body: 'CMMI is a direct lever in DoD source selections and contract management. It appears in RFPs as either a pass/fail eligibility criterion or a scored evaluation factor. For USG acquisition professionals, CMMI requirements protect against contractors who win on paper but lack the organizational discipline to execute consistently. For contractors, ML3 is often the price of admission for major programs — and the PAL database means you cannot fake it.',
              keyTerms: [
                { term: 'CMMI-DEV v1.3 vs v2.0', definition: 'CMMI v2.0 was released in 2018, reorganizing "Process Areas" into "Practice Areas." Many DoD solicitations still reference v1.3 terminology. Both versions are officially recognized but are not directly comparable in structure.' },
                { term: 'Process Area (PA)', definition: 'A specific capability domain within CMMI — e.g., Requirements Management (REQM), Risk Management (RSKM), Configuration Management (CM). ML3 requires 17+ process areas to be satisfied with defined, institutionalized processes.' },
                { term: 'Organizational Process Assets (OPA)', definition: 'The library of standard processes, lessons learned, measurement data, and tailoring guidelines a CMMI ML3 organization maintains and deploys across all projects.' },
                { term: 'Scope mismatch', definition: 'The most common CMMI compliance gap: a contractor holds an appraisal for one organizational unit but proposes a different unit that has no appraisal.' },
                { term: 'DFARS 252.234-7002', definition: 'The DFARS EVM clause that for software-intensive programs over certain thresholds also requires contractors to maintain a current CMMI-DEV ML3+ appraisal or have an approved plan to achieve it within 24 months.' },
              ],
              keyPoints: [
                'How CMMI appears in RFPs — two forms|||Hard pass/fail: "Offerors must hold a current CMMI-DEV ML3 or higher SCAMPI A appraisal for the organizational unit performing this work." Non-compliant proposals are eliminated. Evaluated factor: "Process maturity will be evaluated — CMMI ML3 or higher is preferred." ML2 gets partial credit; ML3+ gets full credit. Always specify SCAMPI A (not B/C) to prevent contractors from citing internal gap assessments as their CMMI level.',
                'Scope mismatch — the most common CMMI trap in source selection|||A large contractor may hold an ML3 appraisal for Division A but propose Division B, which has no appraisal. The PAL database shows which specific organizational unit was appraised. Require contractors to specify which unit holds the appraisal and confirm it matches the performing unit in their proposal. This is a critical CO and PM responsibility.',
                'SCAMPI A vs SCAMPI B — only A produces an official rating|||SCAMPI A is the full on-site appraisal that produces an official ML rating publishable in the PAL. SCAMPI B and C are lighter gap-analysis assessments that do NOT produce official ratings. A contractor citing a SCAMPI B result as their CMMI level is misrepresenting their status.',
                'The 3-year expiration — build a notification clause|||CMMI appraisals expire after 3 years. A contractor who won a contract on the strength of ML3 may let it lapse during performance. Build this into your contract: "The contractor shall notify the Contracting Officer within 30 calendar days of any change in CMMI appraisal status." Without this, you may not know until it surfaces in a program review.',
                'PMB instability as a CMMI signal|||Rubber baseline behavior — repeatedly moving planned value forward to avoid recording negative schedule variance — often signals a breakdown in Configuration Management (CM) and Project Planning (PP), two of the ML3 process areas. When you see unexplained PMB instability, check whether the contractor is actually following their ML3 process assets or whether the appraisal did not reflect genuine institutionalization.',
              ],
            },
            advanced: {
              title: 'CMMI Strategy — Drafting Requirements, Detecting Gaming, and Program Risk',
              body: 'At the advanced level, CMMI mastery means using it as a source selection discriminator, an enforceable contract requirement, and a leading indicator of execution risk. This covers writing requirements that cannot be gamed, detecting compliance gaps after award, and understanding the DFARS linkage to EVM and business systems.',
              keyTerms: [
                { term: 'Institutionalization', definition: 'The degree to which processes are embedded in the organization\'s culture and are actually followed — not just documented. The gap between "we wrote it down" and "we actually do it this way every time" is where most CMMI compliance failures occur after appraisal.' },
                { term: 'Generic Goals (GGs)', definition: 'CMMI institutionalization requirements applied across all process areas. GG3 (Defined) is the institutionalization gate for ML3 — process areas can be technically satisfied but fail GG3 if not genuinely embedded in practice.' },
                { term: 'Lead Appraiser', definition: 'A CMMI Institute-certified professional authorized to conduct SCAMPI A appraisals. Verifiable in the CMMI Institute\'s Lead Appraiser directory. In source selections, you can contact the Lead Appraiser for scope clarification.' },
                { term: 'Should-Cost vs Will-Cost', definition: 'A CMMI-relevant concept: a genuinely ML3+ contractor\'s process maturity should reduce inefficiencies. Should-Cost analysis can use CMMI process compliance evidence to challenge contractor cost proposals.' },
              ],
              keyPoints: [
                'Writing enforceable CMMI contract requirements|||Weak: "The contractor should have CMMI Level 3." Enforceable: "The contractor shall maintain a current (within 3 years) CMMI-DEV ML3 or higher SCAMPI A appraisal covering the organizational unit performing work under this contract. The contractor shall provide written notification to the Contracting Officer within 30 calendar days of any change in appraisal status. Failure to maintain the required appraisal level constitutes a material breach and grounds for a cure notice." Key elements: specify SCAMPI A, specify the performing unit, require lapse notification, attach a consequence.',
                'DFARS 252.234-7002 — the EVM/CMMI linkage|||For software-intensive programs above certain thresholds, this clause requires contractors to hold a current CMMI-DEV ML3+ appraisal or have an approved plan to achieve it within 24 months of award. The linkage is intentional — DoD recognized that process maturity and EVM reliability are directly correlated. If this clause is missing from your EMD contract, raise it with the CO before award.',
                'Detecting CMMI gaming in source selection|||Red flags: (1) Appraisal completed days before proposal submission — may be a rush appraisal without genuine institutionalization. (2) Appraisal scope covers a suspiciously small organizational unit that exactly matches the proposed work scope. (3) Key personnel in the proposal were not part of the appraised organization. Counter-measures: require contractors to submit the SCAMPI A appraisal scope statement; ask in oral presentations who leads day-to-day process compliance; note the Lead Appraiser\'s name for independent verification via the CMMI Institute directory.',
                'PMB instability as an ML3 institutionalization failure|||An ML3 organization\'s Configuration Management (CM) and Project Planning (PP) process areas directly govern PMB integrity. When you see PMB instability (rubber baseline), request that DCMA conduct a CMMI process compliance review focused specifically on these process areas. Frame the request: "Please assess whether the contractor\'s documented ML3 CM and PP processes are being applied to this program." This converts a vague EVM concern into a specific, auditable process compliance question.',
                'ML4 and ML5 — when to require them|||Requiring ML4/5 without understanding what you are asking for is checkbook program management. ML4 means statistical process control — the contractor measures defect rates, cycle times, and productivity quantitatively and uses that data to manage. Relevant for: safety-critical or mission-critical software (nuclear C2, flight controls), high-volume rapid delivery schedules, or performance-based contracts where process efficiency directly affects margins. Only require ML4+ when you can evaluate what it means in proposals and verify it in surveillance.',
                'CMMI process areas most relevant to systems engineering RFPs|||CMMI-DEV ML3 satisfies 17+ process areas. The ones most relevant to defense systems engineering proposals: Requirements Development (RD), Requirements Management (REQM), Technical Solution (TS), Product Integration (PI), Verification (VER), Validation (VAL), and Configuration Management (CM). A contractor claiming ML3 has defined, institutionalized practices for all of these. Look for evidence of these PAs in the contractor\'s SEMP, WBS, and test planning documents when evaluating technical proposals.',
              ],
              quiz: [
                {
                  id: 'cmmi-q1',
                  question: 'A defense contractor claims they are "CMMI Level 3 certified." What is the most accurate correction?',
                  options: [
                    'This is correct — CMMI Level 3 is the industry standard certification',
                    'CMMI uses the term "appraised" not "certified" — a SCAMPI A produces a Maturity Level rating valid for 3 years, not a permanent certification',
                    'Only CMMI Level 5 organizations can be considered certified',
                    'Certification requires annual renewal; CMMI appraisals last indefinitely',
                  ],
                  correct: 1,
                  explanation: 'CMMI produces appraisal ratings, not certifications. A SCAMPI A appraisal conducted by a certified Lead Appraiser results in a Maturity Level rating published in the PAL database, valid for 3 years. The term "certified" is common shorthand in industry but technically incorrect — in source selections, the distinction between a current appraisal and an expired one matters significantly.',
                },
                {
                  id: 'cmmi-q2',
                  question: 'A contractor\'s PAL entry shows a current CMMI-DEV ML3 appraisal. What is the single most important additional verification before accepting this as meeting your RFP requirement?',
                  options: [
                    'Confirm the Lead Appraiser\'s current certification status with the CMMI Institute',
                    'Verify that the appraised organizational unit matches the unit that will actually perform work under your contract',
                    'Require the contractor to submit their full Organizational Process Asset library',
                    'Confirm the appraisal used CMMI v2.0 rather than the legacy v1.3 model',
                  ],
                  correct: 1,
                  explanation: 'Scope mismatch is the most common CMMI compliance gap. A large contractor may hold an ML3 appraisal for Division A while proposing Division B, which has no appraisal. The PAL database shows which specific organizational unit was appraised. Verifying the performing unit matches the appraised unit is a critical CO and program office responsibility that is frequently overlooked.',
                },
                {
                  id: 'cmmi-q3',
                  question: 'What is the key difference between a SCAMPI A and a SCAMPI B appraisal?',
                  options: [
                    'SCAMPI A covers hardware; SCAMPI B covers software development',
                    'Only SCAMPI A produces an official Maturity Level rating publishable in the PAL; SCAMPI B is a lighter gap-analysis assessment that does not produce an official rating',
                    'SCAMPI A requires government oversight; SCAMPI B is conducted independently',
                    'SCAMPI B replaced SCAMPI A in the CMMI v2.0 model update',
                  ],
                  correct: 1,
                  explanation: 'SCAMPI has three classes: A, B, and C. Only Class A produces an official Maturity Level rating publishable in the PAL and citable in proposals or contract compliance. Classes B and C are internal readiness assessments — lighter, faster, and not publicly verifiable. A contractor citing a SCAMPI B result as their CMMI level is misrepresenting their status.',
                },
                {
                  id: 'cmmi-q4',
                  ...
                  options: [
                    'Immediately report the contractor to DCMA for EVM non-compliance',
                    'Request that DCMA conduct a CMMI process compliance review focusing on Configuration Management (CM) and Project Planning (PP) — the ML3 process areas that directly govern PMB integrity',
                    'Require the contractor to upgrade to CMMI ML4 as a corrective action',
                    'Accept the changes since the contractor holds a current ML3 appraisal',
                  ],
                  correct: 1,
                  explanation: 'An ML3 organization is required to have functional Configuration Management (CM) and Project Planning (PP) process areas — both govern PMB integrity. PMB instability suggests these processes are not being followed post-appraisal (an institutionalization failure). The right response is a targeted DCMA process compliance review, not a blanket EVM escalation. Holding an appraisal does not guarantee day-to-day compliance.',
                },
                {
                  id: 'cmmi-q5',
                  ...
                  correct: 2,
                  explanation: 'DFARS 252.234-7002 (Earned Value Management System) includes provisions requiring contractors on software-intensive programs above specified thresholds to hold a current CMMI-DEV ML3+ appraisal or have an approved plan to achieve it within 24 months. This reflects DoD\'s recognition that EVM reliability and process maturity are directly correlated.',
                },
              ],
            },
          },
